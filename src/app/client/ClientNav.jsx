...
const links = [
  ...
  { href: '/client/services', label: 'Services', icon: Package },
];
        ...
        <div ref={panelRef} className="relative">
          ...
          {notificationsOpen && (
            <>
              ...
              <div
                className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-11
                  w-auto sm:w-[350px] max-w-none sm:max-w-[calc(100vw-2rem)]
                  bg-white border border-[#e5e1d8] rounded-2xl shadow-[0_20px_55px_rgba(36,40,45,.14)]
